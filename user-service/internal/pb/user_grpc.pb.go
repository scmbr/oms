...
type UserServiceClient interface {
	...
	ValidateRefreshToken(ctx context.Context, in *ValidateRefreshRequest, opts ...grpc.CallOption) (*ValidateRefreshResponse, error)
}
...
func (c *userServiceClient) ValidateRefreshToken(ctx context.Context, in *ValidateRefreshRequest, opts ...grpc.CallOption) (*ValidateRefreshResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidateRefreshResponse)
...
type UserServiceServer interface {
	...
	ValidateRefreshToken(context.Context, *ValidateRefreshRequest) (*ValidateRefreshResponse, error)
...
func (UnimplementedUserServiceServer) ValidateRefreshToken(context.Context, *ValidateRefreshRequest) (*ValidateRefreshResponse, error) {
...
func _UserService_ValidateRefreshToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ValidateRefreshToken(ctx, req.(*ValidateRefreshRequest))
	}
	return interceptor(ctx, in, info, handler)
}
